...
{
    [Serializable]
    public class Warlock_Mask: Item
    {

        //Constructors
        public Warlock_Mask(String Name, d3vector Requirements, Osobini Bonus, int mValue, int value, String img)
