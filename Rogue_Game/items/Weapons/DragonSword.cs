   ...
   public class DragonSword:Item
    {
        ...
        //Constructors
       public DragonSword(String Name, d3vector Requirements, Osobini Bonus, int mValue, int value,String img)
